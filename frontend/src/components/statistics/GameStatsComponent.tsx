...
const GameStatsComponent: React.FC<{ statistics: Statistics }> = ({
  ...
  return (
    <>
    <div className="flex justify flex-col w-full h-full bg-white">
      <div className='flex justify flex-row w-full h-3/5'>
        <div className='flex justify flex-col w-1/2 h-full'>
          <div className='flex justify flex-col w-full h-2/5 bg-zinc-500'>
            <GameStat>
            ...
            <div className='flex justify flex-col w-full h-3/5 bg-teal-500'>
              <GameStat>
        ...
        <div className='flex justify flex-col w-1/2 h-full bg-pink-500'>
          <GameStat>
      ...
      <div className='flex justify flex-col w-full h-2/5 bg-red-500'>
        <GameStat>
